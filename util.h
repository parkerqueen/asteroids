...
// Global variables to hold the music files
extern Mix_Music *music;
extern Mix_Chunk *fire;
extern Mix_Chunk *thrust;
extern Mix_Chunk *explosion;
extern Mix_Chunk *beat;

// Loads the music files into global variables
void loadmedia();
...
void DrawLine(int x1, int y1, int x2, int y2, int lwidth = 2,
